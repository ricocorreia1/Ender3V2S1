...
#endif
// PT-BR: a ProUI (DWIN) tambem usa LCD_LANGUAGE — sem isto ela fica presa em ingles
#if NONE(HAS_MARLINUI_HD44780, HAS_MARLINUI_U8GLIB, HAS_TFT_LVGL_UI, TFT_COLOR_UI, DGUS_LCD_UI_E3S1PRO, DWIN_LCD_PROUI)
  #undef LCD_LANGUAGE
#endif
